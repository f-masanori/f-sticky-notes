...
import { $getListDepth, $isListItemNode, $isListNode, ListItemNode, ListNode } from '@lexical/list'
    ...
    <>
      <LexicalComposer initialConfig={initialConfig}>
        ...
        <div className='editor-inner'>
          <RichTextPlugin
            contentEditable={<ContentEditable {...containerProps} className='editor-input' />}
            placeholder={''}
          />
          <OnChangePlugin
